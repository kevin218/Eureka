...
def parametric_sweep_S3(objective_function, bounds_var, eventlabel,
    ...
    for var1 in range(bounds_var[0], bounds_var[1] + 1):
        ...
        try:
            x = np.array([var1])
            fitness_value = objective_function(x, eventlabel, s3_meta_GA,
                                               s4_meta_GA, s5_meta_GA, params,
                                               scaling_MAD_white,
                                               scaling_MAD_spec,
                                               scaling_chi2red)
...
def parametric_sweep_S4(objective_function, bounds_var, eventlabel,
                        ...
                        s5_meta_GA, params, scaling_MAD_white,
...
def parametric_sweep_double(objective_function, bounds_var1, bounds_var2,
                            eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA,
                            params, scaling_MAD_white, scaling_MAD_spec,
                            scaling_chi2red):
    """
    ...
    for var1 in range(bounds_var1[0], bounds_var1[1] + 1):
        for var2 in range(bounds_var2[0], bounds_var2[1] + 1):
            ...
            try:
                ...
                fitness_value = objective_function(x, eventlabel, s3_meta_GA,
                                                   s4_meta_GA, s5_meta_GA,
                                                   params, scaling_MAD_white,
                                                   scaling_MAD_spec,
                                                   scaling_chi2red)
