...
# Objective Function
def dqmask(x, eventlabel, s3_meta_GA, s4_meta_GA, 
           scaling_MAD_white, scaling_MAD_spec):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
...
# Objective Function
def expand(x, eventlabel, s3_meta_GA, s4_meta_GA, 
           scaling_MAD_white, scaling_MAD_spec):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
    Differences in Light Curve Analysis
...
# Objective Function
def bg_thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, 
              scaling_MAD_white, scaling_MAD_spec):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
    Differences in Light Curve Analysis
...
# Objective Function
def bg_hw_spec_hw(x, eventlabel, s3_meta_GA, s4_meta_GA, 
                  scaling_MAD_white, scaling_MAD_spec):
    """
...
# Objective Function
def bg_deg(x, eventlabel, s3_meta_GA, s4_meta_GA, 
           scaling_MAD_white, scaling_MAD_spec):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
    Differences in Light Curve Analysis
...
# Objective Function
def bg_method(x, eventlabel, s3_meta_GA, s4_meta_GA, 
              scaling_MAD_white, scaling_MAD_spec):
    """
...
# Objective Function
def p3thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, 
             scaling_MAD_white, scaling_MAD_spec):
    """
...
# Objective Function
def median_thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, 
                  scaling_MAD_white, scaling_MAD_spec):
    """
...
# Objective Function
def window_len(x, eventlabel, s3_meta_GA, s4_meta_GA,
               scaling_MAD_white, scaling_MAD_spec):
    """
...
# Objective Function
def p5thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, 
             scaling_MAD_white, scaling_MAD_spec):
    """
...
# Objective Function
def p7thresh(x, eventlabel, s3_meta_GA, s4_meta_GA,
             scaling_MAD_white, scaling_MAD_spec):
    """
