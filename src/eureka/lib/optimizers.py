...
def parametric_sweep_S3(objective_function, bounds_var, eventlabel,
                        ...
                        scaling_MAD_white, scaling_MAD_color,
                        scaling_chi2red):
    """
...
def parametric_sweep_S4(objective_function, bounds_var, eventlabel,
                        ...
                        scaling_MAD_color, scaling_chi2red):
    """
    Eureka! Optimization Tools: Parametric Sweep
...
def parametric_sweep_double(objective_function, bounds_var1, bounds_var2,
                            ...
                            params, scaling_MAD_white, scaling_MAD_color,
                            scaling_chi2red):
    """
...
def genetic_algorithm(population_size, generations, min_bounds, max_bounds,
                      ...
                      s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
                      scaling_MAD_white, scaling_MAD_color, scaling_chi2red,
                      target_fitness=None):
    """
