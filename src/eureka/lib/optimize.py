...
def dqmask(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
           bounds_dqmask, eventlabel, params, scaling_MAD_white, 
    ...
    best_param, best_fitness_value = optimizers.parametric_sweep_dqmask(
        objective_funcs.dqmask, bounds_dqmask, eventlabel, s3_meta_GA, 
        s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, scaling_MAD_spec, 
        scaling_chi2red
    )
    ...
    return best_param, history_fitness_score, s3_meta_GA, s4_meta_GA, s5_meta_GA


def bg_thresh(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists,
              bounds_bg_thresh, eventlabel, params, scaling_MAD_white, 
              scaling_MAD_spec, scaling_chi2red):
    """
    ...
    best_param, best_fitness_value = optimizers.parametric_sweep_S3(
        objective_funcs.bg_thresh, bounds_bg_thresh, eventlabel, s3_meta_GA, 
        s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, scaling_MAD_spec, 
        scaling_chi2red
    )
...
def bg_hw_spec_hw(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
                  bounds_bg_hw, bounds_spec_hw, eventlabel, params, 
                  scaling_MAD_white, scaling_MAD_spec, scaling_chi2red, 
                  spec_hw_selection, bg_hw_selection):
    """
    ...
    best_params, best_fitness_value = optimizers.parametric_sweep_double(
        objective_funcs.bg_hw_spec_hw, bounds_bg_hw, bounds_spec_hw, 
        eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params, 
        scaling_MAD_white, scaling_MAD_spec, scaling_chi2red
    )
    ...
    return best_params, history_fitness_score, s3_meta_GA, s4_meta_GA, s5_meta_GA


def bg_deg(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
           bounds_bg_deg, eventlabel, params, scaling_MAD_white, 
           scaling_MAD_spec, scaling_chi2red):
    """
    ...
    # Perform parametric sweep
    best_param, best_fitness_value = optimizers.parametric_sweep_S3(
        objective_funcs.bg_deg, bounds_bg_deg, eventlabel, s3_meta_GA, 
        s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, scaling_MAD_spec, 
        scaling_chi2red
    )
...
def bg_method(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
              bounds_bg_method, eventlabel, params, scaling_MAD_white, 
              scaling_MAD_spec, scaling_chi2red):
    """
    ...
    best_param, best_fitness_value = optimizers.parametric_sweep_bg_method(
        objective_funcs.bg_method, bounds_bg_method, eventlabel, s3_meta_GA, 
        s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, scaling_MAD_spec, 
        scaling_chi2red
    )
...
def p3thresh(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
             bounds_p3thresh, eventlabel, params, scaling_MAD_white, 
             scaling_MAD_spec, scaling_chi2red):
    """
    ...
    # Perform parametric sweep
    best_param, best_fitness_value = optimizers.parametric_sweep_S3(
        objective_funcs.p3thresh, bounds_p3thresh, eventlabel, s3_meta_GA, 
        s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, scaling_MAD_spec, 
        scaling_chi2red
    )
...
def median_thresh(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
                  bounds_median_thresh, eventlabel, params, scaling_MAD_white, 
                  scaling_MAD_spec, scaling_chi2red):
    """
    ...
    # Perform parametric sweep
    best_param, best_fitness_value = optimizers.parametric_sweep_S3(
        objective_funcs.median_thresh, bounds_median_thresh, eventlabel, 
        s3_meta_GA, s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, 
        scaling_MAD_spec, scaling_chi2red
    )
...
def window_len(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
               bounds_window_len, eventlabel, params, scaling_MAD_white, 
               scaling_MAD_spec, scaling_chi2red):
    """
    ...
    best_param, best_fitness_value = optimizers.parametric_sweep_odd(
        objective_funcs.window_len, bounds_window_len, eventlabel, 
        s3_meta_GA, s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, 
        scaling_MAD_spec, scaling_chi2red
    )
...
def p7thresh(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
             bounds_p7thresh, eventlabel, params, scaling_MAD_white, 
             scaling_MAD_spec, scaling_chi2red):
    """
    ...
    # Perform parametric sweep
    best_param, best_fitness_value = optimizers.parametric_sweep_S3(
        objective_funcs.p7thresh, bounds_p7thresh, eventlabel, s3_meta_GA, 
        s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, scaling_MAD_spec, 
        scaling_chi2red
    )
...
def expand(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
           bounds_expand, eventlabel, params, scaling_MAD_white, 
           scaling_MAD_spec, scaling_chi2red):
    """
    ...
    # Perform parametric sweep
    best_param, best_fitness_value = optimizers.parametric_sweep_S3(
        objective_funcs.expand, bounds_expand, eventlabel, s3_meta_GA, 
        s4_meta_GA, s5_meta_GA, params, scaling_MAD_white, scaling_MAD_spec, 
        scaling_chi2red
    )
...
def sigma(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, manual_clip_lists, 
          bounds_sigma, eventlabel, last_s3_meta_outputdir, params, 
          scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
    ...
    best_param, best_fitness_value = optimizers.parametric_sweep_S4(
        objective_funcs.sigma, bounds_sigma, eventlabel, 
        last_s3_meta_outputdir, s3_meta_GA, s4_meta_GA, s5_meta_GA, 
        params, scaling_MAD_white, scaling_MAD_spec, scaling_chi2red
    )
...
def parametric_sweep_box_width(s3_meta_GA, s4_meta_GA, s5_meta_GA, best, 
                               manual_clip_lists, bounds_box_width, eventlabel, 
                               last_s3_meta_outputdir, params, 
    ...
    # Perform parametric sweep
    best_param, best_fitness_value = optimizers.parametric_sweep_S4(
        objective_funcs.box_width, bounds_box_width, eventlabel, 
        last_s3_meta_outputdir, s3_meta_GA, s4_meta_GA, s5_meta_GA, 
        params, scaling_MAD_white, scaling_MAD_spec, scaling_chi2red
    )
