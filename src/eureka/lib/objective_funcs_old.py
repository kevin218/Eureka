...
# Objective Function
def diffthresh(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
...
# Objective Function
def dqmask(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
           scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
    ...
    s5_meta_GA.dqmask = dqmask_value
...
# Objective Function
def expand(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
           scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
    Differences in Light Curve Analysis
...
# Objective Function
def bg_thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
              scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
    Differences in Light Curve Analysis
...
# Objective Function
def bg_hw_spec_hw(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
                  scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
    ...
    if x[0] >= x[1]:
        ...
        # Stage 5
        s5_meta_GA.bg_hw = x[0]
        s5_meta_GA.spec_hw = x[1]
...
# Objective Function
def bg_deg(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
           scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
    Eureka! Optimization Tools: Objective Function for Thresholding
    Differences in Light Curve Analysis
...
# Objective Function
def bg_method(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
              scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
    ...
    bg_method_value = remove_apostrophes(x[0])  # Assuming x[0] is a string, e.g. 'std'
    ...
    s5_meta_GA.bg_method = bg_method_value
    ...
    s5_meta = s5.fitlc(eventlabel, params, 
                       input_meta=s5_meta_GA, s4_meta=s4_meta)
...
# Objective Function
def p3thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
             scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
...
# Objective Function
def median_thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
                  scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
...
# Objective Function
def window_len(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
               scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
...
# Objective Function
def p5thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
             scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
...
# Objective Function
def p7thresh(x, eventlabel, s3_meta_GA, s4_meta_GA, s5_meta_GA, params,
             scaling_MAD_white, scaling_MAD_spec, scaling_chi2red):
    """
...
def highpassWidth(x, eventlabel, last_s3_meta_outputdir, s3_meta, s4_meta_GA,
    ...
    -------
    fitness_value : float
        A calculated score indicating the effectiveness of the `highpassWidth`
        value in `x[0]`. Lower scores suggest a more optimal setting for the
        `highpassWidth` parameter.

    Notes:
    -----
    - The function sets the `highpassWidth` parameter in the metadata of Stages
      4 and 5 based on `x[0]`.
    - Stage 4 takes the most recent output of Stage 3 as an input, specified
      by `last_s3_meta_outputdir`.
    - The objective score is a weighted combination of the chi-squared value
