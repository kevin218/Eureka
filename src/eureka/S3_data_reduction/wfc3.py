...
def cut_aperture(data, meta, log):
    ...
    apdata = np.ma.masked_where(apmask == 0, apdata)
    aperr = np.ma.masked_where(apmask == 0, aperr)
    apbg = np.ma.masked_where(apmask == 0, apbg)
    apv0 = np.ma.masked_where(apmask == 0, apv0)
