...
# import eureka.S5_lightcurve_fitting.s5_fit_multSpec_July2024 as s5
...
def Stage5(eventlabel, run_dir, transits_to_mask, residuals_white_dir_list=None):
    ...
    for c in range(matching_chan_count):
        ...
        s5_meta = s5.fitlc(eventlabel, ecf_path=ecf_path, s4_meta=None, input_meta=s5_meta_multspec, residuals_white_dir_list=residuals_white_dir_list)
