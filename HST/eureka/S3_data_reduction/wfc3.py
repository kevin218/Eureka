...
from ..lib import suntimecorr, utc_tt, util, optimizers
...
def read(filename, data, meta, log):
    ...
    - November 17, 2023 Reza Ashtari
        Import trace offset for WFC3 observations
    '''
    ...
    # Import trace offset for WFC-3 observations from optimizer_inputs.txt
    offset_trace = optimizer_params['offset_trace']
    ...
    if meta.inst != "wfc3":
        ...
        xrange = np.arange(0 - offset_trace, meta.nx - offset_trace)
