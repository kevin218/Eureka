...
def fitlc(eventlabel, ecf_path=None, s4_meta=None, input_meta=None, residuals_white_dir_list=None):
    ...
    for spec_hw_val in meta.spec_hw_range:
        for bg_hw_val in meta.bg_hw_range:
            ...
            if meta.multwhite:
                # Initialize lc_whites as a single-element list
                lc_whites = [lc, ]

            # if meta.divide_white is True:
            #     lc_whites_divided = []

            #     if residuals_white_dir_list is None:
            #         raise ValueError("residuals_white_dir_list cannot be None")

            #     for i in range(len(residuals_white_dir_list)):
            #         residuals_white_dir = residuals_white_dir_list[i]
            ...
            #         # Append the updated lc to the new list
            #         lc_whites_divided.append(lc)

            #     # Reassign lc_whites to the updated list
            #     lc_whites = lc_whites_divided
            ...
            if meta.multwhite:
                ...
                for pi in range(len(meta.inputdirlist)+1):
                    ...
                    if meta.divide_white is True:
                        meta.residuals_white_dir = residuals_white_dir_list[pi]
