...
def test_MIRI(capsys):
    ...
    if s2_installed:
        ...
        # name = pathdirectory(meta, 'S1', meta.run_s1,
    ...
    meta.outputdir_raw = (f'data{os.sep}JWST-Sim{os.sep}MIRI{os.sep}'
                          f'Stage3{os.sep}')
    name = pathdirectory(meta, 'S3', meta.run_s3, ap=4, bg=10,
    ...
    meta.outputdir_raw = (f'data{os.sep}JWST-Sim{os.sep}MIRI{os.sep}'
                          f'Stage4{os.sep}')
    name = pathdirectory(meta, 'S4', meta.run_s4, ap=4, bg=10,
    ...
    meta.outputdir_raw = (f'data{os.sep}JWST-Sim{os.sep}MIRI{os.sep}'
                          f'Stage5{os.sep}')
    name = pathdirectory(meta, 'S5', meta.run_s5, ap=4, bg=10,
    ...
    meta.outputdir_raw = (f'data{os.sep}JWST-Sim{os.sep}MIRI{os.sep}'
                          f'Stage6{os.sep}')
    name = pathdirectory(meta, 'S6', meta.run_s6, ap=4, bg=10,
