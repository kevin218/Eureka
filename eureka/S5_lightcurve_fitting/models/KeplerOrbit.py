...
class KeplerOrbit(object):
    ...
    obliq : float
        ptional): The obliquity (axial tilt) of body 2 (in degrees toward body 1).
    argobliq : float
        ptional): The reference orbital angle used for obliq (in degrees from inferior conjunction).
    t_peri : float
    ...
    def __init__(self, a=const.au.value, Porb=None, inc=90., t0=0., e=0., Omega=270., argp=90., # orbital parameters
        ...
        argp : float, optional
            The argument of periastron (in degrees CCW from Omega).
        m1 : float, optional
            The mass of body 1 in kg.
        m2 : float, optional
            The mass of body 2 in kg.
    ...
    def eccentric_anomaly(self, t, useFSSI=None, xtol=1e-10):
        ...
        xtol : float
            Tolarance on error in eccentric anomaly.
