...
"""
Eureka! Optimization for JWST MIRI LRS Data
---------------------------------------------

Description:
This script is designed to optimize the stage 1-4 ECF parameters for JWST MIRI LRS observations. 

Inputs:
- Loaded from an input text file, 'optimizer_inputs_miri_LRS.txt'.
...
if __name__ == "__main__":
    ...
    optimizer_params = optimizers.read_inputs("optimizer_inputs_miri_LRS.txt")
    ...
    if bg_hw_selection == "auto":
        s3_meta_GA.bg_hw = s3_meta_GA.spec_hw  # MIRI-LRS
    ...
    # STEP 1.2 - Save best S3 & S4 ECF values and update ECF files
    ...
    # Define ECF file paths for Stages 3 and 4.
    ...
    if __name__ == "__main__":
        source_file = "optimizer_inputs_miri_LRS.txt"
        destination_directory = outputdir_optimization
        destination_filename = "optimizer_inputs_miri_LRS_copy.txt"
