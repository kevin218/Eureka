...
if __name__ == "__main__":
    ...
    optimizer_params = optimizers.read_inputs("optimizer_inputs_nirspec_PRISM.txt")
    ...
    if spec_hw_selection == "auto":
        s3_meta_GA.spec_hw = 4  # # NIRSPEC-G395H & PRISM
    ...
    ## STEP 1.0 - Run Stages 1 and 2 once and store Stage 2 directory to avoid 
    # re-running Stages 1 and 2 during Stage 3 optimization (Saves Time)
    ...
    ## STEP 1.0 - Run Stage 3 once and store Stage 3 directory to avoid re-running 
    # Stage 3 during Stage 4 optimization (Saves Time)
