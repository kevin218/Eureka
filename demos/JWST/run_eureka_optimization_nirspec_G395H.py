...
if __name__ == "__main__":
    ...
    if bounds_bg_deg_s1 == "auto":
        bounds_bg_deg_s1 = [
            0,
            1,
        ]  # or none! <-- not as important for AI-ML, optimizing from S3 on
    ...
    filepath_history_plot = os.path.join(outputdir_optimization, "OptimizationHistory.png")
